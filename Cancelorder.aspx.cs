...
namespace Tugas5
{
    public partial class Cancelorder : System.Web.UI.Page
    {
        ...
        {
            if (SqlDBHelper.ExecuteNonQuery("delete from detail_tiket where id_detail_tiket = @us", CommandType.Text, new NpgsqlParameter("@us", Convert.ToInt32(TextBox1.Text))))
            {
